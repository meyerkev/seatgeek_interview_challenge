...
const NumDifferentClientTypes = 3
...
func (t *Tester) Start() {
	...
	numSeatsPerType := t.numSeats / NumDifferentClientTypes
	numRepeatersPerType := t.concurrency / NumDifferentClientTypes
...
func NewTester(consumerPort int, numSeats int, concurrencyLevel int, logger *Logger) *Tester {
